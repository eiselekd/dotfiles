...
\(fn CELL-REF &optional KVIEWSPEC-FLAG)" nil nil)
...
and formatted koutlines." nil nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "kmenu" '("id-popup-kotl-menu" "kotl-")))

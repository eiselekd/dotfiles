;;; multi-mode-util.el --- Utilities for multiple major mode

;; Copyright (C) 2010-2013 Lintaro INA

;; Author: INA Lintaro <tarao.gnn at gmail.com>
;; URL: https://github.com/tarao/multi-mode-util
;; Version: 0.0.2
;; Package-Requires: ((multi-mode "1.13"))
;; Keywords: convenience, languages, major-mode
